...
class XcacheCacheTest extends \DeliciousBrains\WPMDB\Container\Doctrine\Tests\Common\Cache\CacheTest
{
    ...
    {
        return new \DeliciousBrains\WPMDB\Container\Doctrine\Common\Cache\XcacheCache();
    }
}
