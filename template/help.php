...
$videos = array(
	'SlfSuuePYaQ' => array(
		...
		'desc' => 'A brief walkthrough of the WP Migrate DB plugin showing all of the different options and explaining them.'
	),
	'IFdHIpf6jjc' => array(
		'title' => 'Pulling Live Data Into Your Local Development&nbsp;Environment',
		'desc' => 'This screencast demonstrates how you can pull data from a remote, live WordPress install and update the data in your local development environment.'
	),
	'FjTzNqAlQE0' => array(
		'title' => 'Pushing Local Development Data to a Staging&nbsp;Environment',
		'desc' => 'This screencast demonstrates how you can push a local WordPress database you\'ve been using for development to a staging environment.'
	),
	'0aR8-jC2XXM' => array(
