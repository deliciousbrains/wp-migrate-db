<div class="option-section backup-options" style="display: block;">
	<label for="create-backup" class="backup-checkbox checkbox-label">
		...
		<span class="directory-scope pull"><?php _e( 'Backup the local database before replacing it', 'wp-migrate-db' ); ?></span>
		<span class="directory-scope push hide"><?php _e( 'Backup the remote database before replacing it', 'wp-migrate-db' ); ?></span>
		<br/>
